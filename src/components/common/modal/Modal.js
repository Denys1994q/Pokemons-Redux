...
import { randomPokemons_openModal } from "../../random-pokemons/randomPokemonsSlice";
                ...
                <CSSTransition in={showModal} timeout={4000} classNames='my-modal'>
                    <div onClick={() => dispatch(randomPokemons_openModal(false))} className='modal-wrapper'>
                        <div className='modall'>
                            ...
                            <p className='modall-title'>{activePokemon ? pokemons[activePokemon].name : null}</p>
                            <div className='modall-photo'>
                                <img
                                    src={
                                        activePokemon
                                            ? pokemons[activePokemon].sprites.other.dream_world.front_default
                                            : null
                                    }
                                    alt=''
                                />
                            ...
                            <ul>Experience: {activePokemon ? pokemons[activePokemon].base_experience : null}</ul>
                        </div>
